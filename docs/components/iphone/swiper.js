      ...
      prependSlide: function (e) {
        ...
        if (s.params.virtual.cache) {
          ...
          Object.keys(e).forEach(s => {
            ...
            r &&
              a.attr('data-swiper-slide-index', parseInt(r, 10) + i),
              (t[parseInt(s, 10) + i] = a)
          }),
            (s.virtual.cache = t)
        }
...
function Keyboard(e) {
  ...
  function o() {
    t.keyboard.enabled ||
      ($(r).on('keydown', l), (t.keyboard.enabled = !0))
  }
  function d() {
    t.keyboard.enabled &&
      ($(r).off('keydown', l), (t.keyboard.enabled = !1))
  }
  ...
  function c() {
    ...
    if (
      ('fraction' === s.type &&
        ...
        r
          .find(classesToSelector(s.totalClass))
  ...
  function b(e) {
    ...
    if (!(a < p.slideWidth && i < p.slideHeight)) {
      ...
      e.cancelable && e.preventDefault(),
        ...
        (u.isMoved = !0),
        (u.currentX =
          u.touchesCurrent.x - u.touchesStart.x + u.startX),
        (u.currentY =
          u.touchesCurrent.y - u.touchesStart.y + u.startY),
        u.currentX < u.minX &&
          (u.currentX =
            u.minX + 1 - (u.minX - u.currentX + 1) ** 0.8),
        u.currentX > u.maxX &&
          (u.currentX =
            u.maxX - 1 + (u.currentX - u.maxX + 1) ** 0.8),
        u.currentY < u.minY &&
          (u.currentY =
            u.minY + 1 - (u.minY - u.currentY + 1) ** 0.8),
        u.currentY > u.maxY &&
          (u.currentY =
            u.maxY - 1 + (u.currentY - u.maxY + 1) ** 0.8),
        ...
        (h.y =
          ...
          (Date.now() - h.prevTime) /
          2),
        Math.abs(u.touchesCurrent.x - h.prevPositionX) < 2 &&
          (h.x = 0),
        Math.abs(u.touchesCurrent.y - h.prevPositionY) < 2 &&
          (h.y = 0),
    ...
    s.gestures
      ...
      : 'touchstart' === t.touchEvents.start &&
        ...
        t.touchEvents.cancel &&
          t.$wrapperEl.on(t.touchEvents.cancel, r, w, a)),
      t.$wrapperEl.on(
        t.touchEvents.move,
              ...
              if (
                (o
                  ...
                  : (c &&
                    ...
                    d &&
                      (n.attr('src', d), n.removeAttr('data-src'))),
    ...
    a('fromEdge toEdge afterInit lock unlock', () => {
      t.params.a11y.enabled &&
        (function () {
          ...
          s &&
            s.length > 0 &&
            (t.isBeginning ? (p(s), l(s)) : (u(s), n(s))),
            e &&
              e.length > 0 &&
              (t.isEnd ? (p(e), l(e)) : (u(e), n(e)))
        })()
    }),
    a('paginationUpdate', () => {
      t.params.a11y.enabled &&
...
function Thumb(e) {
  ...
  function n() {
    ...
    const s = e.clickedIndex,
      a = e.clickedSlide
    if (a && $(a).hasClass(t.params.thumbs.slideThumbActiveClass))
      return
    if (null == s) return
    let i
    if (
    ...
    setTranslate: () => {
      ...
      for (let e = 0, t = a.length; e < t; e += 1) {
        ...
        if (
          ...
          0 === e.length &&
            (e = createShadow(r, t, n ? 'left' : 'top')),
            0 === s.length &&
              (s = createShadow(r, t, n ? 'right' : 'bottom')),
    ...
    setTranslate: () => {
      ...
      for (let s = 0; s < e.length; s += 1) {
        ...
        if ((m && f.shadow) || !m) {
          ...
          if (
            (0 === e.length && f.shadow && (e = createShadow(r, a)),
            e.length)
          ) {
